...
const ClubProfile = () => {
  ...
  return (
    <div>
      ...
      >
        <h3 className="text-3xl font-bold text-white mb-8 text-left">What We Do</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white">
          <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
            <div className="flex items-center mb-4">
              ...
              <h4 className="ml-4 text-xl font-semibold">Game Change 2025
              </h4>
            </div>
            <p>The 2020–2025 Strategic Plan of the National Society of Black Engineers (NSBE), reshapes the work of the Society’s mission to enable greater success in the coming era of social and economic transformation.
</p>
          </div>
          <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
            <div className="flex items-center mb-4">
