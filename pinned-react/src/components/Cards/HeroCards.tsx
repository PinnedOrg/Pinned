...
const HeroCards = () => {
  return (
    <div>
      <div className=" relative max-w-full lg:w-[700px] lg:h-[500px] flex flex-wrap justify-center gap-10 gap-y-16 md:gap-16 mt-20 lg:mt-0 z-10 xl:ml-10 text-card-foreground shadow-sm">
        {/* Students */}
