...
const AboutCard = ( member : AboutCardType) => {
  return (
    ...
    <Card className="flex flex-col items-center justify-center gap-3 p-4 bg-white border shadow-md dark:bg-slate-900 rounded-xl dark:shadow-slate-800 border-slate-200 dark:border-slate-800 max-w-[25rem]" >
