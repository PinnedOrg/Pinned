const About = () => {
return (
    <section id="about" className="container pb-10 animate-fade-in-up  max-w-[50rem] place-self-center">
      <h2 className="text-3xl font-bold text-center md:text-4xl">
        About Pinned
      </h2>
      <p className="mt-4 text-base text-center md:text-lg text-muted-foreground">
